...
public class TrelloClient {
    ...
    public List<TrelloBoardDto> getTrelloBoards() {
        ...
        try {
            TrelloBoardDto[] boardsResponse = restTemplate.getForObject(getAppUrl(), TrelloBoardDto[].class);
    ...
    public CreatedTrelloCardDto createNewCard(TrelloCardDto trelloCardDto) {
        ...
        return restTemplate.postForObject(getTrelloCardUrl(trelloCardDto), null, CreatedTrelloCardDto.class);
    }
}
